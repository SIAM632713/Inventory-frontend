...
import {useCreatBrandMutation} from "@/redux/feature/brandAPI/brandAPI.js";
import {getBaseURL} from "@/utilitis/getBaseURL.js";
import axios from "axios";

const CreateBrand = () => {

    const [creatBrand]=useCreatBrandMutation()
    ...
    const handleSubmit =async (e) => {
        ...
        try {
            ...
            await creatBrand(newBrand).unwrap()
        ...
        >
            ...
            >
                ...
                <motion.div variants={itemVariants} className="mb-4 sm:mb-6">
                    ...
                    <label className="flex flex-col items-center justify-center w-full h-28 sm:h-32 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-blue-500 transition-colors">
                        <div className="flex flex-col items-center justify-center pt-4 sm:pt-5 pb-4 sm:pb-6">
                            ...
                            <p className="text-xs sm:text-sm text-gray-500 text-center px-2">Click to upload logo</p>
