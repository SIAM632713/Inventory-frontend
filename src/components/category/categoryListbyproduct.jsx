...
import {useListbyCategoryQuery, useListByKeywordServiceQuery} from "@/redux/feature/productAPI/product.API.js";
import {motion} from "framer-motion";
import {FaSearch} from "react-icons/fa";
import {useParams} from "react-router-dom";

const CategoryListbyproduct = () => {

    const {categoryID}=useParams()
    const {data,error,isLoading}=useListbyCategoryQuery(categoryID)
...
export default CategoryListbyproduct;